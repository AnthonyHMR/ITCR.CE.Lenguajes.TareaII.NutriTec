...
padecimientos(p1, 'dislipidemia', 'problemas de control de colesterol', s2).
...
dietas(s3, d1, 3000, [p1, p2, p3, p4], [p5],['no hacer cardio'], ['trotar 3 días por semana','hacer campotraviesa'], detalle1).
