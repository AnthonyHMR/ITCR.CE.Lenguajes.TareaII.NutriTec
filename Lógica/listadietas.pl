...
detalledieta(detalle2, '
Desayuno:
Yogur con semillas de linaza, acompañado con un rollito de queso y jamón de pavo.

Almuerzo:
Pollo a la plancha cortado en tiras con ensalada de pepino, lechuga y tomate aderezada con aceite de oliva y limón.

Merienda:
Huevo cocido con unos palitos de zanahoria.

Cena:
Salmón a la plancha con ensalada de brócoli, zanahoria y tomate aderezada con limón y aceite de linaza.').
detalledieta(detalle3, '
Desayuno:
-gallo pinto
-plátano maduro
-jugo de naranja fortificado con calcio o leche de almendra o soja fortificada con calcio

Almuerzo:
-sopa de frijoles blancos con vegetales
-arroz integral
-trozos de piña
-1 manzana

Merienda:
1 vaso de batido de soja enriquecido, con una cucharada de postre con miel.
- Galletas (4 u.)
...
Medio filete  de salmón con romero
Puré de papas O zanahorias

Merienda:
2 puñados de semillas de girasol o de calabaza tostadas
1 taza de batido de leche de soja con fresas

Cena:
2 platos de sopa de calabaza con alga kombu.
').
detalledieta(detalle5, '
Desayuno
1/2 banano
...
detalledieta(detalle6, '
Desayuno:
-1 plato de gallo pinto con huevo, queso y planano maduro
-1 taza de café
-Fruta de preferencia

Merienda:
1 Banano
2 Waffles con mantequilla de maní
Jugo de naranja (1 taza)

Almuerzo:
Arroz con pollo
Frijoles refritos (1/2 taza)
Ensalada Asiática de Repollo
Papas tostadas (1 oz)
Refresco natural
